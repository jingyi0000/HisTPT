...
from .cityscapes_semseg_dataset_mapper import CityscapesSemDatasetMapper
from .cityscapes_insseg_dataset_mapper import CityscapesInsDatasetMapper
from .ade_semseg_dataset_mapper import ADESemDatasetMapper
from .acdc_semseg_dataset_mapper import ACDCSemDatasetMapper
from .pascalcontext_semseg_dataset_mapper import PascalContextSemDatasetMapper
from .mapillary_semseg_dataset_mapper import MapillarySemDatasetMapper