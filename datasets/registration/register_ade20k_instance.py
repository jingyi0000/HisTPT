...
_PREDEFINED_SPLITS = {
    ...
    "ade20k_instance_train": (
        "ADE20K/ADEChallengeData2016/images/train",
        "ADE20K/ADEChallengeData2016/ade20k_instance_train.json",
    ),
    "ade20k_instance_val": (
        "ADE20K/ADEChallengeData2016/images/val",
        "ADE20K/ADEChallengeData2016/ade20k_instance_val.json",
    ),
}
