...
class ShapeSampler(nn.Module):
    ...
    def from_config(cls, cfg, is_train=True, mode=None):
        max_candidate = cfg['STROKE_SAMPLER']['MAX_CANDIDATE'] # 1
        candidate_probs = cfg['STROKE_SAMPLER']['CANDIDATE_PROBS'] # [0.25, 0.25, 0.25, 0.25]
        candidate_names = cfg['STROKE_SAMPLER']['CANDIDATE_NAMES'] # ["Point", "Polygon", "Scribble", "Circle"]
