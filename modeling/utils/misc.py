...
def get_class_names(name):
    ...
    elif 'ade20k_instance' in name:
        return ADE_THING + ["background"]
    elif 'ade' in name:
    ...
    elif name == 'cityscapes_val_sem_seg':
        return CITYSCAPES + ["background"]
    elif name == 'cityscapes_instance_seg_val':
        return CITYSCAPES_THING + ["background"]
    elif name in ['fog_acdc_val_sem_seg','night_acdc_val_sem_seg','rain_acdc_val_sem_seg','snow_acdc_val_sem_seg']:
        return CITYSCAPES + ["background"]
    elif name in ['fog_acdc_val_ins_seg','night_acdc_val_ins_seg','rain_acdc_val_ins_seg','snow_acdc_val_ins_seg']:
        return CITYSCAPES_THING + ["background"]
    elif name in ['bdd10k_val_ins_seg']:
        return CITYSCAPES_THING + ["background"]
    elif name == "pascalcontext_val_sem_seg":
        return PASCAL_CONTEXT + ["background"]
    elif name == "mapillary_vistas_sem_seg_val":
        return MAPILLARY + ["background"]
