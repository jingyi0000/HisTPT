...
def hook_switcher(model, name):
    mappings = {}
    if name in ['cityscapes_val_sem_seg', 'scannet_21_val_seg', 'scannet_38_val_seg', 'scannet_41_val_seg', 'sunrgbd_37_val_seg', 'context_59_val_seg', 'context_459_val_seg', 'voc_2012_val_seg', 'bdd10k_val_sem_seg', 'ade20k_val_sem_seg','ade20k_full_sem_seg_val','fog_acdc_val_sem_seg','night_acdc_val_sem_seg','rain_acdc_val_sem_seg','snow_acdc_val_sem_seg','pascalcontext_val_sem_seg','mapillary_vistas_sem_seg_val']:
        mappings = {'SEMANTIC_ON': True, 'INSTANCE_ON': False, 'PANOPTIC_ON': False}
    elif name in ['cityscapes_instance_seg_val','fog_acdc_val_ins_seg','night_acdc_val_ins_seg','rain_acdc_val_ins_seg','snow_acdc_val_ins_seg','bdd10k_val_ins_seg', 'ade20k_instance_val'] or 'seginw' in name:
